...
We emphasize that user interaction techniques are \emph{not} the same as user assessment techniques discussed later, since user assessment techniques do not fundamentally change AIA algorithms or capabilities to exploit user interaction. %%(but rather provide data to the user and leave it up to them to infer assurances from this data).  
...
%Enabling mobile robots and human to share or `fuse' information via semantic natural language can have an effect on trust. 
