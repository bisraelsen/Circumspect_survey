...
\subsection{Related Work}\label{sec:rel_work}
    ...
    \textbf{I THINK THERE ARE A COUPLE OTHER PAPERS THAT PROBABLY BELONG HERE, I NEED TO THINK ABOUT THIS SOME MORE}

    While assurances are defined by \citeauthor{Lillard2016-yg}, and mentioned by \citeauthor{McKnight2001-fa}, and \citeauthor{Corritore2003-gx}, we investigate in detail how assurances fit within the trust cycle (from Figure \ref{fig:SimpleTrust_one_way}), survey what methods of assurance have been and are currently being used, then present a refined definition and classification of assurances. In essence others have noted the existence of assurances, and we now directly consider the question: \textbf{\emph{How can assurances be designed?}, and take steps towards creating a design guide to that end. --- REVISIT THIS}

    \edit{discuss work by \citet{Doshi-Velez2017-xy}, and \citet{Weller2017-zx}, possibly \citet{Lipton2016-ug} as well}
