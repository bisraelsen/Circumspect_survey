...
%
    % \subsubsection{Measuring Changes in TRBs} Researchers often measure how long AIAs are able to run under full autonomy, before the autonomy is turned off by users .
    % Other researchers assess user's willingness to cooperate with AIAs \cite{}.
