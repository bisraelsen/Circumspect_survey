...
\subsection{Artifically Intelligent Agents}
    ...
    Concretely, the following systems currently exist and possess the following AI capabilities.
...
\section{Calibration of Trust-Related Behaviors}
    ...
    A simple feedback loop, as illustrated in Figure \ref{fig:SimpleTrust_loop} will allow the AI to calibrate the TRBs of the user by providing feedback that will be called assurances in this paper. Figure \ref{fig:SimpleTrust_dist} serves as a simple example illustrating the possible disparity between the user TRB distribution and the appropriate TRB distribution. In this case assurances would be used to minimize the difference between the two distributions.
	...
	\begin{figure*}[htbp]
        ...
        \begin{subfigure}[t]{0.48\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth]{Figures/SimpleTrust_loop}
            \caption{Simple Feedback loop that allows an AI to influence User Trust in order to calibrate the TRBs.} 
            \label{fig:SimpleTrust_loop}%
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.48\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth]{Figures/SimpleTrust_dist}
            \caption{A hypothetical user TRB distribution and the appropriate TRB distribution. Calibrating TRBs involves making the two distributions as similar as possible.}
            \label{fig:SimpleTrust_dist}%
        \end{subfigure}
        \caption{Calibration of User Trust-Related Behaviors}
